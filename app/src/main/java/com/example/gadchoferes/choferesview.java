...
public class choferesview extends AppCompatActivity implements Asynchtask {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_choferesview);
        ...
        WebService ws= new WebService(
                ...
                datos, choferesview.this, choferesview.this);
        ws.execute("GET");
    ...
    public void processFinish(String result) throws JSONException {
        TextView txtSaludo = findViewById(R.id.txtresp1);
        ...
        for (int i = 0; i < JSONlista.length(); i++) {
            ...
            lstLista.append(i + 1).append(".- ")
                    .append(chofer.getString("nombre")).append("\n")
                    .append("   Cédula: ").append(chofer.getString("cedula")).append("\n")
                    .append("   Teléfono: ").append(chofer.getString("telefono")).append("\n")
